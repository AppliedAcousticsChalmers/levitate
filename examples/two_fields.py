...
# The levitation trap is found using a minimization sequence.
# First just the phases are optimized for just a trap,
...
# The haptics point can be created usin a simple focusing algorithm,
...
# Visualize the individual fields, as well as the compund field.
array.complex_amplitudes = trap_results
plot([array.visualize.pressure(), array.visualize.transducers()], filename='trap_results.html')
array.complex_amplitudes = haptics_result
plot([array.visualize.pressure(), array.visualize.transducers()], filename='haptics_results.html')
array.complex_amplitudes = haptics_result * 0.3 + trap_results * 0.7
plot([array.visualize.pressure(), array.visualize.transducers()], filename='combined_results.html')
