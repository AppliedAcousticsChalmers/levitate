...
def test_pressure_null():
    ...
    np.testing.assert_allclose(phase_jac_1, np.array([[-4.15076576e+02, 4.15076576e+02], [-1.58764044e+07, 1.58764044e+07], [-6.36647795e+07, 6.36647795e+07], [-1.43245754e+08, 1.43245754e+08]]))
    np.testing.assert_allclose(ampl_jac_1, np.array([[2.07034544e+02, 2.14379234e+02], [9.82115445e+06, 6.44203586e+06], [3.11989198e+07, 3.34520183e+07], [7.01975696e+07, 7.52670412e+07]]))
    np.testing.assert_allclose(val_12, np.stack([val_1, val_2], -1))
    np.testing.assert_allclose(phase_jac_12, np.stack([phase_jac_1, phase_jac_2], -1))
    np.testing.assert_allclose(ampl_jac_12, np.stack([ampl_jac_1, ampl_jac_2], -1))
    ...
    np.testing.assert_allclose(phase_jac_1, np.array([-2.22786938e+08, 2.22786938e+08]))
    np.testing.assert_allclose(ampl_jac_1, np.array([1.11217644e+08, 1.15161095e+08]))
    np.testing.assert_allclose(val_12, np.stack([val_1, val_2], -1))
    np.testing.assert_allclose(phase_jac_12, np.stack([phase_jac_1, phase_jac_2], -1))
    np.testing.assert_allclose(ampl_jac_12, np.stack([ampl_jac_1, ampl_jac_2], -1))
