...
@pytest.mark.parametrize("t_model, args, atol, rtol", [
    ...
    (levitate.transducers.CylinderModes, {'radius': 30e-3, 'height': 100e-3, 'dB_limit': 30}, 0, 1e-6)
])
...
def test_ReflectingTransducer():
    ...
    np.testing.assert_allclose(transducer.pressure_derivs(source_pos, source_normal, receiver_pos), expected_result)
    expected_result = np.array([
        [-8.087400159223e+01 + 3.774404722898e+01j, -1.310160863990e+01 + 1.925658748885e+01j],
        [+1.736579921887e+01 - 1.692481425111e+01j, +2.260066865426e+01 - 1.834169950946e+01j],
        [-3.624707929924e+01 - 4.406388477273e+01j, +1.205007097737e+01 - 4.474957584822e+00j],
        [+3.013184473716e+01 - 4.745786415815e+00j, +1.139639183484e+01 - 2.130879881987e+01j],
        [+5.681479397234e+00 + 1.549973225601e+00j, -2.985452447307e+01 + 1.327530075928e+01j],
        [+7.083176489272e+01 - 1.130395863412e+01j, -1.620300465813e+01 - 1.549977255905e-01j],
        [+1.440198921746e+02 - 6.635057096114e+01j, -1.899174298433e+01 + 7.472544028936e+00j],
        [-4.572029430157e+01 + 4.025651971799e+01j, -1.235903534170e+01 + 1.127298552539e+01j],
        [-4.643710097860e-01 - 3.556291701197e+00j, -9.713937048793e+00 + 2.132160118551e+01j],
        [-6.118804178934e+00 + 1.449427242208e+00j, +3.441849047585e+01 - 6.169067697777e+00j],
        [-3.689254274777e+01 + 1.465472717813e+01j, +1.577967722695e+01 + 6.261438740028e+00j],
        [-5.368225679010e+01 + 5.518356615362e+01j, +1.959981925073e+01 + 3.178607941706e+00j],
        [+3.958262524291e+01 + 5.650003034680e+01j, +1.148246653078e+01 - 5.200023010047e+00j],
        [-9.419450564357e+01 + 1.012041728551e+01j, +2.330516328371e+01 - 3.955752161621e+00j],
        [+3.760617590291e+01 - 1.697889270774e+01j, +7.984359218340e+00 - 1.649436338189e+01j],
        [-4.726309681556e+00 + 2.920259106752e+00j, +8.833528970836e+00 - 2.105735284708e+01j]])
    np.testing.assert_allclose(transducer.spherical_harmonics(source_pos, source_normal, receiver_pos, orders=3), expected_result)
...
def test_CylinderModes():
    transducer = levitate.transducers.CylinderModes(radius=30e-3, height=100e-3, dB_limit=30)
    expected_result = np.array([+2.850550871103e+00 - 5.679056656596e-04j, -2.049563603795e+01 + 5.042629969144e-03j])
    np.testing.assert_allclose(transducer.pressure(source_pos, source_normal, receiver_pos), expected_result)
    expected_result = np.array([
        [+2.850550871103e+00 - 5.679056656596e-04j, -2.049563603795e+01 + 5.042629969144e-03j],
        [+6.278081378878e+02 - 1.316041170666e-01j, +1.481500606826e+03 - 2.131142028494e-01j],
        [+4.238298232782e+03 + 3.100626929968e-01j, -1.247804170910e+04 + 1.810495675957e+00j],
        [-1.540180296324e-10 + 6.004305243531e-15j, +3.130355631127e+03 - 2.866176085591e-01j],
        [-5.181547028178e+05 + 9.362133455680e+01j, +1.125024233928e+05 - 3.182861190920e+01j],
        [-9.841719512259e+05 + 3.542988708899e+02j, +8.049905178619e+06 - 2.401508848537e+03j],
        [-3.670797755144e+04 - 1.428908867331e+02j, +2.859307814499e+06 - 2.749149492445e+02j],
        [-7.741578758634e+05 + 1.821031671033e+02j, -9.944584644695e+05 + 2.826074805330e+02j],
        [-9.406595530774e-09 + 2.684806081205e-13j, +3.121577687293e+04 + 2.466830979703e+00j],
        [-7.532775165848e-09 + 1.834543764564e-12j, -2.273589745075e+05 - 2.027685838371e+01j],
        [+2.228264583347e+07 + 5.640991099223e+04j, -1.398914275070e+07 + 2.164220584040e+03j],
        [-1.399839937367e+09 - 1.667378340718e+05j, +6.705267363330e+09 - 9.303746862238e+05j],
        [+6.622131075357e-05 - 2.968645979525e-09j, -7.957985938889e+08 + 3.436869799476e+04j],
        [-7.964834724213e+07 + 5.881797270521e+04j, +1.022574854864e+08 - 1.466402312334e+04j],
        [+3.517617114530e-06 - 5.269954411500e-11j, -1.375729472072e+07 + 1.525608587125e+03j],
        [-4.123725230249e+08 + 1.538521966439e+04j, -7.979745748198e+08 + 1.090033682021e+05j],
        [+1.378412572601e-05 - 2.089651920865e-10j, -8.745033319371e+08 + 1.181238841683e+05j],
        [+5.460411177025e+07 - 1.110433538949e+03j, +1.651351160696e+07 + 3.316217677035e+03j],
        [-8.032477669493e+08 - 5.837069593148e+04j, -1.074780210384e+08 - 2.754525566247e+04j],
        [+6.395830005946e-06 - 9.492103099683e-11j, +1.087130506752e+08 - 1.350868120666e+04j]
    ])
    np.testing.assert_allclose(transducer.pressure_derivs(source_pos, source_normal, receiver_pos), expected_result)
